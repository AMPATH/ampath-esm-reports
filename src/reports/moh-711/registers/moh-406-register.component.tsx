...
import { moh406ExportColumns } from './moh-406.columns';
        ...
        <table className={classNames(`${styles.table}`, `${styles.tableBordered}`, `${styles.tableStriped}`)}>
          ...
          <tbody>
            ...
            {patientlist?.length > 0 ? (
              ...
              <tr>
                <td colSpan={moh406Columns.length} className={styles.textCentre}>
                  No data available
                </td>
              </tr>
            )}
